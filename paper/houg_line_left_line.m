...
Z2 = reshape(data(781:780*2,5),[30,26]);
...
Z3 = reshape(data(780*2+1:780*3,5),[30,26]);
...
Z4 = reshape(data(780*3+1:780*4,5),[30,26]);
...
Z5 = reshape(data(780*4+1:780*5,5),[30,26]);
...
Z6 = reshape(data(780*5+1:780*6,5),[30,26]);
