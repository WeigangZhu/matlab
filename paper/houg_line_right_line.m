...
Z2 = reshape(data(781:780*2,10),[30,26]);

% plot3(X, Y, Z, 'r.')
mesh(X2,Y2,Z2, 'linewidth', 1)
h1 = xlabel('$$MinLength$$');
h2 = ylabel('$$LineGap$$');
h3 = zlabel('$$IsRight$$');
grid on
...
Z3 = reshape(data(780*2+1:780*3,10),[30,26]);

% plot3(X, Y, Z, 'r.')
mesh(X3,Y3,Z3, 'linewidth', 1)
h1 = xlabel('$$MinLength$$');
h2 = ylabel('$$LineGap$$');
h3 = zlabel('$$IsRight$$');
grid on
...
Z4 = reshape(data(780*3+1:780*4,10),[30,26]);

% plot3(X, Y, Z, 'r.')
mesh(X4,Y4,Z4, 'linewidth', 1)
h1 = xlabel('$$MinLength$$');
h2 = ylabel('$$LineGap$$');
h3 = zlabel('$$IsRight$$');
grid on
...
Z5 = reshape(data(780*4+1:780*5,10),[30,26]);

% plot3(X, Y, Z, 'r.')
mesh(X5,Y5,Z5, 'linewidth', 1)
h1 = xlabel('$$MinLength$$');
h2 = ylabel('$$LineGap$$');
h3 = zlabel('$$IsRight$$');
grid on
...
Z6 = reshape(data(780*5+1:780*6,10),[30,26]);

% plot3(X, Y, Z, 'r.')
mesh(X6,Y6,Z6, 'linewidth', 1)
h1 = xlabel('$$MinLength$$');
h2 = ylabel('$$LineGap$$');
h3 = zlabel('$$IsRight$$');
grid on
